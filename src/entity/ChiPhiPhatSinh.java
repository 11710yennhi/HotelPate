...
public class ChiPhiPhatSinh {
	...
	// Constructor
	public ChiPhiPhatSinh(String maChiPhiPhatSinh, String tenChiPhiPhatSinh, String loaiChiPhiPhatSinh,
	...
	public String toString() {
		return "ChiPhiPhatSinh [maChiPhiPhatSinh=" + maChiPhiPhatSinh + ", tenChiPhiPhatSinh=" + tenChiPhiPhatSinh
				+ ", loaiChiPhiPhatSinh=" + loaiChiPhiPhatSinh + ", donViTinh=" + donViTinh + ", gia=" + gia + "]";
	}
}
